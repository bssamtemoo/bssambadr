...
if __name__ == '__main__':
 ...
 # arguments
 args = ArgumentParser()
 args.add_argument('visits',help='The amount of visits ex: 10000')
 args.add_argument('urllist',help='https://www.youtube.com/watch?v=o7P7nWzGHLc')
 args.add_argument('min',help='Minimum watch time in seconds ex: 15')
 args.add_argument('max',help='Maximum watch time in seconds ex: 30')
